...
#include <fstream>
using namespace std;
int obn,prnt_once=0,ar[100][100][12][18],hall_no;
...
public:
    ...
    int ext,dir_customer=0;//to save the hall number
...
{
    cout<<"ENTER THE NUMBER OF MOVIE HALLS IN UR AREA\n";
    cin>>hall_no;
    ...
    {
        cout<<"Enter the movie hall name:\n";
        cin>>mov_halname[i];
        (*p)=mov_halname[i];
        p++;
    }
...
getch();
         ...
         { (*this).hall_print();
            cout<<"CHOOSE THE HALL NUMBER TO BOOK TICKET IN THAT HALL\n";
